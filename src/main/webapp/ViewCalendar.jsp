                ...
                <form name="CAction" action="calendarView.jsp?GetEventInfo=0&GetCalendarInfo=0">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4">
                            ...
                            <div class="form-group">
                                <div class="col-sm-12">
                                    <label from="CName">Event name:</label>
                                    <input type="text" class="form-control" id="EName" name="EDay" placeholder="No event selected." readonly>
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="col-sm-12">
                            ...
                            <div class="form-group">
                                <div class="col-sm-12">
                                    <label from="CName">Event Info:</label>
                                    <input type="text" class="form-control" id="EInfo" name="EInfo" placeholder="No event selected." readonly>
                                </div>
                            </div>
                        </div>
                    </div>
                    <script>
                        ...
                        var sMyEventName = "${MyEventName}";
                        if (sMyEventName.length > 0)
                        {
                            $("#EName").attr('value', sMyEventName);
                        }

                        var sMyEventInfo = "${MyEventInfo}";
                        if (sMyEventInfo.length > 0)
                        {
                            $("#EInfo").attr('value', sMyEventInfo);
                        }
                    </script>
                    </body>
                    </html>
